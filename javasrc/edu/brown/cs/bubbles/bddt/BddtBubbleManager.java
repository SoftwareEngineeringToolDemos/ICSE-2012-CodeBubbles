...
{
   createSourceBubble(bt.getStack(),0,BubbleType.EXEC);
}


void createSourceBubble(BumpThreadStack stk,int frm,BubbleType typ)
{
   ...
   if (stk.getNumFrames() <= frm) return;
