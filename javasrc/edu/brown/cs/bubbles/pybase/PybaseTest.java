...
private void runTest()
{
   ...
   sendCommand("STARTFILE",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' ID='" + (edit_id++) + "'",null);
   sendCommand("JAVASEARCH",proj,"PATTERN='genkml.genkml()' DEFS='true' REFS='false' FOR='METHOD'",null);
   sendCommand("ELIDESET",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' COMPUTE='true'","<REGION START='505' END='1722' />");
   sendCommand("STARTFILE",proj,"FILE='/home/spr/Pybles/test/testproject/src/scanzips.py' ID='" + (edit_id++) + "'",null);
   sendCommand("JAVASEARCH",proj,"PATTERN='scanzips.output(...)' DEFS='true' REFS='false' FOR='METHOD'",null);
   sendCommand("ELIDESET",proj,"FILE='/home/spr/Pybles/test/testproject/src/scanzips.py' COMPUTE='true'","<REGION START='318' END='655' />");
   sendCommand("FINDDEFINITIONS",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='548' END='548' RONLY='T' EXACT='true' EQUIV='true'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='548' END='548' EXACT='true' EQUIV='true'",null);
   sendCommand("GETFULLYQUALIFIEDNAME",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='1076' END='1076'",null);
   sendCommand("JAVASEARCH",proj,"PATTERN='genkml.*' DEFS='true' REFS='false' FOR='FIELD'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='580' END='580' EXACT='true' EQUIV='true'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='611' END='611' EXACT='true' EQUIV='true'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='643' END='643' EXACT='true' EQUIV='true'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='287' END='287' EXACT='true' EQUIV='true'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='1076' END='1076' EXACT='true' EQUIV='true'",null);
   sendCommand("FINDREGIONS",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' STATICS='T' CLASS='genkml'",null);
   sendCommand("FINDREGIONS",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' IMPORTS='T' CLASS='genkml'",null);
   sendCommand("EDITFILE",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' ID='" + (edit_id++) + "' NEWLINE='true'","<EDIT START='679' END='679'>#</EDIT>");
   sendCommand("EDITFILE",proj,"FILE='/home/spr/Pybles/test/testproject/src/scanzips.py' ID='" + (edit_id++) + "' NEWLINE='true'","<EDIT START='342' END='342'><![CDATA[ ]]></EDIT>");
   sendCommand("EDITFILE",proj,"FILE='/home/spr/Pybles/test/testproject/src/scanzips.py' ID='" + (edit_id++) + "' NEWLINE='true'","<EDIT START='358' END='361'></EDIT>");
   sendCommand("SEARCH",proj,"PATTERN='output' FLAGS='2' MAX='256'",null);
   sendCommand("FINDREFERENCES",proj,"FILE='/home/spr/Pybles/test/testproject/src/genkml.py' START='635' END='635' EXACT='true' EQUIV='true' RONLY='T'",null);
